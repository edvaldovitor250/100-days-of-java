...
## Desafio:
	...
	Escreva um programa Java que simule o funcionamento de um sistema de gestão de estoque para uma loja, permitindo adicionar, remover e atualizar informações de produtos.
