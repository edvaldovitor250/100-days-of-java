...
Desenvolva um aplicativo em Java que simule o funcionamento de um sistema de gerenciamento de projetos, permitindo criar, atribuir tarefas e acompanhar o progresso.
