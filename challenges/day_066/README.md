...
Escreva um programa Java que simule o funcionamento de um sistema de reserva de carros em uma locadora, permitindo reservar, cancelar e visualizar carros disponíveis.
